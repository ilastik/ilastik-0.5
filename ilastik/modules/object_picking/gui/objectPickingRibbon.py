...
class ObjectsTab(IlastikTabBase, QtGui.QWidget):
    ...
    def on_btn3D_clicked(self):
        ...
        sel_over = self.parent.project.dataMgr[self.parent._activeImageNumber].overlayMgr["Objects/Selection Result"]
        
        if sel_over is None:
            print "No input overlay has been selected - nothing to show in 3D"
            return
        
        print "3D view"
        suppress   = sel_over.backgroundClasses
        smooth     = sel_over.smooth3D
        vol        = sel_over._data[self.ilastik.labelWidget.selectedTime,:,:,:,0]
        colorTable = sel_over.colorTable
        ...
        self.ilastik.labelWidget.overview.SetColorTable(colorTable)
        self.ilastik.labelWidget.overview.DisplayObjectMeshes(vol, suppress, smooth)
    ...
    def on_btnClearAll_clicked(self):
        ...
        self.ilastik._activeImage.overlayMgr["Objects/Selection"]._data[:]=0
